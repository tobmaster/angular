...
function filterNodeClasses(driver: AnimationDriver, rootElement: any, selector: string): any[] {
...
function collectEnterElements(driver: AnimationDriver, allEnterNodes: any[]) {
  ...
  const enterNodes = filterNodeClasses(driver, document.body, POTENTIAL_ENTER_SELECTOR);
